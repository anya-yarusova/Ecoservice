            ...
            <div id="home" className="landing-wrapper overflow-hidden">
                ...
                >
                    <div className="mx-4 md:mx-8 mt-0 md:mt-4">
                        ...
                        <Button type="button" label="Присоединиться" rounded className="text-xl border-none mt-3 bg-blue-500 font-normal line-height-3 px-3 text-white"></Button>
                    </div>
                        ...
                        <div className="col-12 lg:col-4 p-0 md:p-3">
                            <div className="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all">
                                ...
                                <div className="my-5 text-center">
                                    ...
                                    <Button label="Узнать больше" rounded className="block mx-auto mt-4 border-none ml-3 font-light line-height-2 bg-blue-500 text-white"></Button>
                                </div>
                            </div>
                        </div>
